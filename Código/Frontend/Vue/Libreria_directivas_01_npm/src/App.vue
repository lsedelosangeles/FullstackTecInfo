...
const listaLibros = libros.libros
...
<template>
  ...
  <div class="base">
    <div class="encabezado">
      ...
      <div class="boton agregarLibro" @click="mostrarTelon()">
        +
      </div>
    </div>
    <div class="contenido">
      <div class="listado">
        <div class="datosLibro" v-for="libro in listaLibros">
...
.agregarLibro {
  ...
  aspect-ratio: 1/1;
  display: flex;
  background-color: rgb(218, 153, 2);
  border: 3px solid #49461c;
  border-radius: 20px;
  color: white;
  font-family: Arial, Helvetica, sans-serif;
  font-size: 3em;
...
.nuevoLibro {
  ...
  background-color: #fdfbdf;
  border-radius: 20px;
  border: 3px rgb(218, 153, 2) solid;
...
.nuevoLibro .formulario:nth-child(2n+1) {
  color: green;
  font-weight: bolder;
  text-align: left;
  text-indent: 10px;
...
.boton:hover {
  -webkit-box-shadow: 5px 5px 7px -1px #49461c;
  box-shadow: 5px 5px 7px -1px #49461c;
  cursor: pointer;
}
...
.cerrar {
  ...
  color: white;
  border: #690303 solid 2px;
  border-radius: 25px;
  font-weight: bolder;
}

.cerrar:hover {
  -webkit-box-shadow: 3px 3px 4px -1px #49461c;
  box-shadow: 3px 3px 4px -1px #49461c;
  cursor: pointer;
}
